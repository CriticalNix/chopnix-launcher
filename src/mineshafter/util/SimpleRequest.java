...
public class SimpleRequest
{
  public static byte[] get(String url)
  {
    try
    {
      return get(new URL(url)); } catch (MalformedURLException e) {
    }
    return null;
  }
  ...
  public static byte[] post(String url, byte[] data) {
    try {
      return post(new URL(url), data); } catch (MalformedURLException e) {
    }
    return null;
  }
  ...
  public static byte[] post(URL url, byte[] data)
  {
    try {
      ...
      return returnStream.toByteArray(); } catch (IOException e) {
    }
    return null;
  }
}