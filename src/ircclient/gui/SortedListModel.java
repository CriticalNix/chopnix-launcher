 ...
 * underlying model.
 * 
 * @author John O'Conner but really it was fc
 */
public class SortedListModel extends AbstractListModel {
	 ...
	 */
	public SortedListModel(DefaultListModel model) {
	 ...
	 *            that should be used
	 */
	public SortedListModel(DefaultListModel model, SortOrder sortOrder) {
	...
	public void add(Object o) {
		unsortedModel.addElement(o);
	}

	public void removeElement(Object o) {
		unsortedModel.removeElement(o);
	}
	...
	public boolean contains(Object elem) {
		return unsortedModel.contains(elem);
	}

	public ArrayList<String> toArrayList() {
		ArrayList<String> array = new ArrayList<String>();
		for (int i = 0; i < getSize(); i++) {
			array.add(this.getElementAt(i).toString());
		}
		return array;
	}
	...
	private int findInsertionPoint(SortedListEntry entry) {
		...
		if (sortOrder != SortOrder.UNORDERED) {
			insertionPoint = Collections
					.binarySearch((List) sortedModel, entry);
			if (insertionPoint < 0) {
	...
	class SortedListEntry implements Comparable {
		...
		public int compareTo(Object o) {
			...
			// model
			Object thatElement = unsortedModel.getElementAt(thatEntry
					.getIndex());
