...
public class ServerPanel extends JPanel {
	...
	public ServerPanel(IRCWindow win, String name, String server, int port,
			String nick, String[] autojoin, String nickPass, boolean log,
			boolean ssl) {
		ServerConnection s = new ServerConnection(server, port, nick, autojoin,
				nickPass, this);
		this.serv = s;
		this.win = win;
		this.name = ("ChopNix");
