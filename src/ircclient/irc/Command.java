...
public class Command {
	...
	public Command(String cmdd, ChannelPanel cp) throws IOException {
		...
		if (cmd.startsWith("join")) {
			...
			cp.getServPane().getServer().getOutput()
					.ctcpsay(chan, cmdd.substring(3));
			cp.getChat().appendCTCP(cp.getServPane().getServer().getNick(),
					cmdd.substring(3));
